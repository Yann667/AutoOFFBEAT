...
for a rod at the end of a second cycle. It is not a catastrophe for the regime to continue, but it is something a digital twin shall report.
...
result appeared excellent but they were not as two observations invalidated it. They were made by confronting this domain with the reference
simulation of the previous section.

Firstly, the rod reaches \textbf{thermal equilibrium within a few thousand
...
Secondly, the reference simulation runs to \SI{6.3e7}{\second}, that
is about \textbf{ten thousand times} beyond the upper bound of the training
domain. Yet the phenomena that matters for safety (swelling, creep, gap closure,
PCMI) unfold precisely over these long time scales. Hence they were entirely absent from the
experiments. The surrogate was therefore modelling only the
...
gap closure, and therefore the occurence of PCMI. The circumferential strain also
becomes non-monotonic and changes sign, reflecting the inward creep of the
cladding before the pellet pushes it back. Figure~\ref{fig:parite} compares the values predicted by a \textit{leave-one-out}
