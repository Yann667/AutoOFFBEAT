...
% Cover illustration : cutaway of the reference case at end of cycle, rendered
% from the simulation itself (rapport/couverture3d.py).
\includegraphics[width=0.82\textwidth]{couverture_3d.png}\\[-2pt]
{\footnotesize\itshape Cutaway of the simulated rod at end of cycle :
\SI{1365}{\kelvin} at the pellet centre, \SI{602}{\kelvin} at the cladding
surface.\par}
