...
Taken with the two preceding cases, this one showed me a pattern in my own way
...
measurement, and none of them needed application code to be rewritten. What I
...
I had thought of these two components as independent: a correctness fix in the
threshold base silently invalidated a learning target two layers away. I only
caught it because I had got into the habit of re-running the whole chain after
each change.
