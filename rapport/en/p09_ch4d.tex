...
I wrote twenty-six requests covering the six tools exposed to the agent, plus
...
I had written those descriptions the way one writes documentation, for a human
who would read both and tell them apart. The measurement showed me they are what
...
These two fixes taught me something about my own benchmark. I had been
reporting \SI{88}{\percent} success while the task the agent is actually for was
failing every time, because I had only ever measured the link I had thought to
instrument. \textbf{I now try to run the whole chain before trusting a figure
...
I wrote fifteen questions and, for each one, noted which corpus document
